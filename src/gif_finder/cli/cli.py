...
Usage:
    gif-finder media add PATH --tag TAG [--tag TAG ...] [--author NAME] [--stream-id ID] [--frame-rate N]
    gif-finder media inspect PATH [--frame-rate N]
    gif-finder media view [--tag NAME] [--author NAME] [--stream-id ID]
...
Entity subcommands:
    media   Import, inspect, list (JSON) and delete media entries.
